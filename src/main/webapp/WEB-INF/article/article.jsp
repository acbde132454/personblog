  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Article/checkAll" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="/blog/toView/addArticle">增加文章</a></li>
        </ol>
...
<script>
    ...
    function changeOpen(obj){
        //获取当前文章的主键
        var aid = obj.parent().parent().find("input[type=checkbox]").val();
        $.get("/blog/article/updateIsOpen",{
            'isOpen' : obj.val(),
            'aid' : aid
        },function (data) {
            if(data.ok){
        ...
        $.ajax({
            ...
            success : function (data) {
                ...
                for(var i = 0; i < dataList.length; i++){
                    ...
                    if(article.isOpen == "0"){
                        content += "<tr>\n" +
                            "                <td><input class='son' type=\"checkbox\" class=\"input-control\" name=\"checkbox\" value="+article.aid+" /></td>\n" +
...
function deleteArticle(aid) {
    layui.use('layer', function(){
        ...
        layer.confirm('确认删除这篇文章吗？', {
            ...
            //按钮【按钮一】的回调
            $.get("/blog/article/deleteArticle",{'aid':aid},function (data) {
                if(data.ok){
                    layui.use('layer',function () {
                        var layer = layui.layer;
                        layer.open({
