            ...
            <h1 class="page-header">撰写新文章</h1>
              <div class="form-group">
                  ...
                  <label id="tags" style="margin-top: 10px">
                      <input type="checkbox" name="tid" />户外运动&nbsp;&nbsp;&nbsp;
                      <input type="checkbox" name="tid" />赛艇&nbsp;&nbsp;&nbsp;
                      <input type="checkbox" name="tid" />羽毛球&nbsp;&nbsp;&nbsp;
                      <input type="checkbox" name="tid" />垒球
                  </label>
              </div>
            <div class="form-group">
              ...
              <div class="add-article-box">
                  ...
                  <div class="add-article-box-content">
                      ...
                      <p><label>公开度：</label><input type="radio" name="isOpen" value="0" checked/>公开 <input type="radio" name="isOpen" value="1" />私密</p>
