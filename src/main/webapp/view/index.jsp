...
<head>
    ...
    <link href="/blog/font-awesome-4.7.0/css/font-awesome.css" rel="stylesheet" type="text/css">
    <link href="/blog/css/fore/index_style.css" rel="stylesheet" type="text/css">
    <link href="/blog/css/fore/animate.min.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div id="navgation" class="navgation navgation_close">
        ...
        <div class="logo"><a>Andy.Hu</a></div>
    </div>
                ...
                <div class="warp-box">
                    ...
                    <div class="layui-row">
                        ...
                        <div class="layui-col-xs12 layui-col-sm4 layui-col-md4  wow fadeInUp" data-wow-delay=".2s" style="padding: 0 10px">
                            <div class="single-news">
                                <div class="news-head">
                                    <img src="http://www.lzqcode.com/images/web.jpg">
                                    <a href="#" class="link"><i class="fa fa-link"></i></a>
                                </div>
                                <div class="news-content">
                                    <h4>
                        ...
                        <div class="layui-col-xs12 layui-col-sm4 layui-col-md4  wow fadeInUp" data-wow-delay=".4s" style="padding: 0 10px">
                            <div class="single-news">
                                <div class="news-head">
                                    <img src="http://www.lzqcode.com/images/dedecms.jpg">
                                    <a href="#" class="link"><i class="fa fa-link"></i></a>
                                </div>
                                <div class="news-content">
                                    <h4>
        ...
        <div class="fp-tablecell">
            <div class="page4">
                <div class="warp-box">
                    <div class="about">
                        <div class="inner">
                            <h1 class="wow fadeInLeft">Andy个人博客</h1>
                ...
                <div class="layui-row">
                    ...
                    <div class="layui-col-xs12 layui-col-sm12 layui-col-md4">
                        <div class="single-widget contact">
                            <h2>联系我</h2>
                            <ul class="list">
                                <li><i class="fa fa-map"></i>地址:上海市松江区茸阳路250号歆翱中山科创中心A栋4层</li>
                                <li><i class="fa fa-qq"></i>QQ: 2655904102 </li>
                                <li><i class="fa fa-envelope"></i>邮箱: 2655904102@qq.com</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="layui-row">
                    <div class="layui-col-xs12 layui-col-sm12 layui-col-md12 text-center">
                        <p>Copyright &copy; 2019-2020 Andy个人博客 All Rights Reserved V.5.1.3 粤ICP备1231100号</p>
                    </div>
                </div>
            </div>
        </div>  
