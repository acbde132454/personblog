        ...
        <div class="header-inner">
            ...
            <div class="blog-user">
                <button class="btn btn-default btn-sm"
                        style="border-radius: 20px;background-color:#EDEDED" id="login-btn">登录</button>
                <button class="btn btn-success btn-sm" style="border-radius: 20px;">注册</button>
            </div>
            <a class="phone-menu">
                <i></i>
                <i></i>
...
<%--登录模态窗口--%>
<div class="login"></div>
<div class="wrapper" style="position: fixed;left: 0;top: 0;z-index: 100000">
    <div class="form-inner-cont" style="border:1px solid black">
        <h3>Login now</h3>
